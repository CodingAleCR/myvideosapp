...
export class RESTPlaylistsService extends PlaylistsService {
  ...
  findPlaylists(): Promise<Playlist[]> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(`${this.urlBase}/users/${this.userId}/playlists`, {
  ...
  addPlaylist(playlist: Playlist): Promise<Playlist> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(`${this.urlBase}/users/${this.userId}/playlists`, playlist, {
  ...
  removePlaylist(playlistId: string): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .delete(
          `${this.urlBase}/users/${this.userId}/playlists/${playlistId}`,
          {
            params: { token: this.token }
          }
        )
  ...
  updatePlaylist(playlist: Playlist): Promise<Playlist> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .put(
          `${this.urlBase}/users/${this.userId}/playlists/${playlist.id}`,
          playlist,
          {
            params: { token: this.token }
          }
  ...
  addVideo(playlistId: string, video: Video): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(
          `${this.urlBase}/users/${this.userId}/playlists/${playlistId}/videos`,
          video,
          {
            params: { token: this.token }
          }
