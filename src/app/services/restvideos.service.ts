...
export class RESTVideosService extends VideosService {
  ...
  findVideos(query: string): Promise<Video[]> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(`${this.urlBase}/users/${this.userId}/videos`, {
  ...
  findVideoById(id: string): Promise<Video> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(`${this.urlBase}/users/${this.userId}/videos/${id}`, {
  ...
  addVideo(video: Video): Promise<Video> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(
          `${this.urlBase}/users/${this.userId}/videos`,
          video,
          {
            params: { token: this.token }
          }
  ...
  removeVideo(id: string): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .delete(`${this.urlBase}/users/${this.userId}/videos/${id}`, {
          params: { token: this.token }
        })
        .subscribe(
          (data: any) => {
  ...
  updateVideo(video: Video): Promise<Video> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .put(`${this.urlBase}/users/${this.userId}/videos/${video.id}`, video, {
          params: { token: this.token }
        })
        .subscribe(
          (data: Video) => {
