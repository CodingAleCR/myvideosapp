...
export class UserService {
      ...
      this.http
        ...
        .subscribe(
          (data: { userId: string; token: string }) => {
            ...
            let url = `${this.urlBase}/users/${data.userId}`;
  ...
  createUser(user: User): Promise<User> {
    ...
    return new Promise((resolve, reject) => {
      this.http.post(`${this.urlBase}/users`, user).subscribe(
        (user: User) => {
  ...
  updateUser(user: User): Promise<User> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .put(`${this.urlBase}/users/${this.user.id}`, user, {
  ...
  findUserById(id: string): Promise<User> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(`${this.urlBase}/users/${id}`, { params: { token: this.token } })
        .subscribe(
          (data: any) => {
